...
class tx_in8reports_report_SyslogStatus implements tx_reports_StatusProvider {
	...
	protected function getErrorSyslog(){
		...
		if ($sysconf['enableCheckSyslog']){
			...
			$GLOBALS['TYPO3_DB']->exec_DELETEquery('sys_log', 'details LIKE "Core: Error handler (%): PHP Warning: file_get_contents(%typo3temp/scriptmerger/uncompressed/%) [<a href=\'function.file-get-contents\'>function.file-get-contents</a>]: failed to open stream: No such file or directory in %/typo3conf/ext/scriptmerger/class.tx_scriptmerger.php line%"');
