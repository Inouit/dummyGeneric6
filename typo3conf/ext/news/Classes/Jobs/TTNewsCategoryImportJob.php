...
class Tx_News_Jobs_TTNewsCategoryImportJob extends Tx_News_Jobs_AbstractImportJob {
	 ...
	 *
	 * @param Tx_News_Service_Import_TTNewsCategoryDataProviderService $importDataProviderService
	 * @return void
	 */
	public function injectImportDataProviderService(Tx_News_Service_Import_TTNewsCategoryDataProviderService
